    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {useCases.map(({ icon: Icon, tag, title, desc }, i) => (
            <ScrollReveal key={title} animation="slide-in-up" staggerIndex={i} staggerDelay={100} threshold={0.15}>
              <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
